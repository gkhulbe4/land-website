...
function Edit() {
    ...
    const deleteImg = (index) => {
        axios.delete(`http://localhost:3000/land/${landId}/${index}` , {
            headers: {
    ...
    const submitData = async (e) => {
      ...
      for(let i  =  0 ; i<selectedFiles.length ; i++)
      {
          ...
          try {
              ...
              await axios.put(`http://localhost:3000/edit/${landId}`, { fileUrl }, {
                  headers: {
                      "Content-type": "application/json",
                      Authorization: localStorage.getItem("token"),
                  },
    ...
    <div className="carousel w-full flex">
                ...
                <div key={index+1} id={index+1} className="carousel-item w-full justify-center">
                    <div className='h-96 w-[600px] relative'>
                        <div className='absolute top-5 right-7 p-1 cursor-pointer rounded-3xl bg-black'>
                          <DeleteRoundedIcon className='text-gray-400 hover:text-red-600' fontSize="medium"
      ...
      <div className='flex border-t border-gray-200'>
        <div className='flex-col py-5 w-full'>
          ...
          <textarea className='resize-none outline-none overflow-y-scroll w-full' name="description" id="" cols="30" rows="5"
          value={description}
      ...
      <input className="file-input bg-gray-100 border-gray-300 outline-none rounded-md shadow-sm file-input-ghost w-full max-w-xs" 
            type='file'
            multiple
